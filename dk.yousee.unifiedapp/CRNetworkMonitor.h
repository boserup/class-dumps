...
@class CRReachability, CritterImpl, NSArray, NSMutableArray, NSMutableDictionary, NSString;
...
- (id)requestStateForConnection:(id)arg1 allowCreate:(BOOL)arg2;
- (id)requestStateForConnection:(id)arg1;
- (void)reachabilityChanged:(id)arg1;
- (BOOL)enableReachabilityUpdates;
