...
+ (id)lastActivityResponseToIQ:(id)arg1 withSeconds:(unsigned int)arg2 status:(id)arg3;
+ (id)lastActivityResponseToIQ:(id)arg1 withSeconds:(unsigned int)arg2;
...
- (unsigned int)lastActivitySeconds;
