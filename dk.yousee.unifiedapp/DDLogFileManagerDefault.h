...
@interface DDLogFileManagerDefault : NSObject <DDLogFileManager>
{
    ...
    int _fileNamingConvention;
}

@property int fileNamingConvention; // @synthesize fileNamingConvention=_fileNamingConvention;
@property unsigned int maximumNumberOfLogFiles; // @synthesize maximumNumberOfLogFiles;
- (void).cxx_destruct;
- (id)createNewLogFile;
- (id)generateLogFileNameWithConvention:(int)arg1 attempt:(unsigned int)arg2;
