...
- (void)removeImageForKey:(id)arg1 fromDisk:(BOOL)arg2 withCompletition:(CDUnknownBlockType)arg3;
- (void)removeImageForKey:(id)arg1 fromDisk:(BOOL)arg2;
- (void)removeImageForKey:(id)arg1 withCompletition:(CDUnknownBlockType)arg2;
